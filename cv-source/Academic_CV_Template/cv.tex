...
%-------------------------------------------------------------------------------
\name{Shunsuke Kurita}{}
\position{PhD Student{\enskip\cdotp\enskip}Physics Program}
\address{Hiroshima University, 1-3-2 Kagamiyama, Higashi-Hiroshima-shi, Hiroshima, 739-8511, Japan}

%\mobile{+1 000-000-0000}
\email{kurita@quark.hiroshima-u.ac.jp}
%\homepage{https://www.quark.hiroshima-u.ac.jp/member/22kurita.html}
\github{https://github.com/Shunsuke-Kurita}
%\linkedin{mylinkedin}
% \gitlab{my-gitlab-id}
...
\makecvfooter
  {April 2026}
  {Shunsuke Kurita ~~~·~~~ Curriculum Vitae}
  {\thepage}
